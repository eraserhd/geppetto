...
(deftest t-parse-line
  (are [line tree] (= tree (gcode/parse-line line))
    ...
    "f##1"             '[[::gcode/F (parameter-get (parameter-get 1.0))]]
    "#22=32.4"         '[[::gcode/parameter-set! 22.0 32.4]]
    "#[1+2]=[3+4]"     '[[::gcode/parameter-set! (+ 1.0 2.0) (+ 3.0 4.0)]]
    "##2=3"            '[[::gcode/parameter-set! (parameter-get 2.0) 3.0]]
