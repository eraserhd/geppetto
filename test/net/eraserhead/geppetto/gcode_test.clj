...
(deftest t-parse-line
  (are [line tree] (= tree (gcode/parse-line line))
    ...
    "f2400"            {::gcode/words [[::gcode/F 2400]]}
    "f-4"              {::gcode/words [[::gcode/F -4]]}
    "f+4"              {::gcode/words [[::gcode/F +4]]}
    "f.4"              {::gcode/words [[::gcode/F 0.4]]}
    "f-.4"             {::gcode/words [[::gcode/F -0.4]]}
    "f+.4"             {::gcode/words [[::gcode/F +0.4]]}
    "f -4"             {::gcode/words [[::gcode/F -4]]}
    "f+ .4"            {::gcode/words [[::gcode/F 0.4]]}
    "f+0 .4"           {::gcode/words [[::gcode/F 0.4]]}
    "g1x4.2f99z6"      {::gcode/words [[::gcode/G 1] [::gcode/X 4.2] [::gcode/F 99] [::gcode/Z 6]]}
    "g1 x4.2 f99 z6"   {::gcode/words [[::gcode/G 1] [::gcode/X 4.2] [::gcode/F 99] [::gcode/Z 6]]}
    "f[4]"             '{::gcode/words [[::gcode/F 4]]}
    "f[4 + 7]"         '{::gcode/words [[::gcode/F (+ 4 7)]]}
    "f[4 + 7 + 9]"     '{::gcode/words [[::gcode/F (+ (+ 4 7) 9)]]}
    "f[4-7+8-6]"       '{::gcode/words [[::gcode/F (- (+ (- 4 7) 8) 6)]]}
    "f[4*9]"           '{::gcode/words [[::gcode/F (* 4 9)]]}
    "f[4-6*9]"         '{::gcode/words [[::gcode/F (- 4 (* 6 9))]]}
    "f[4*6/9]"         '{::gcode/words [[::gcode/F (/ (* 4 6) 9)]]}
    "f[1**2**3]"       '{::gcode/words [[::gcode/F (** 1 (** 2 3))]]}
    "f[[3+6]*4]"       '{::gcode/words [[::gcode/F (* (+ 3 6) 4)]]}
    "f[abs[-6]]"       '{::gcode/words [[::gcode/F (abs -6)]]}
    "f[atan[6]/[4]]"   '{::gcode/words [[::gcode/F (atan 6 4)]]}
    "f#1"              '{::gcode/words [[::gcode/F (parameter 1)]]}
    "f##1"             '{::gcode/words [[::gcode/F (parameter (parameter 1))]]}
    ...
    ;; linuxcnc operators
    "f[1 eq 2]"        '{::gcode/words [[::gcode/F (eq 1 2)]]}
    "f[1ne 2]"         '{::gcode/words [[::gcode/F (ne 1 2)]]}
    "f[1 gt2]"         '{::gcode/words [[::gcode/F (gt 1 2)]]}
    "f[1ge2]"          '{::gcode/words [[::gcode/F (ge 1 2)]]}
    "f[1.0lt 2.4]"     '{::gcode/words [[::gcode/F (lt 1.0 2.4)]]}
    "f[1 le 2]"        '{::gcode/words [[::gcode/F (le 1 2)]]}

    ;; linuxcnc precedence, from table 3
    "f[1 and 1 * 2 ** 3 eq 2 - 1 and 6 mod 2]"
    '{::gcode/words [[::gcode/F (and (and 1
                                          (eq (* 1 (** 2 3))
                                              (- 2 1)))
                                     (mod 6 2))]]}

    "f[ExiSTS[#<foo>]]" '{::gcode/words [[::gcode/F (exists "foo")]]}
